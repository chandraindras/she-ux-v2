                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <a href="{{url('/detail-project', $list['id'])}}" class=" color-primary"> {{ $list['project_name'] }}</a>
                          </td>
                          <td>
                            {{ $list['email_user'] }}
                          </td>
                          ...
                          <td>
                            <a type="button" data-toggle="modal" data-target="#inviteMember-{{$list->id}}" class="color-primary">Invite Member</a>
                          </td>
                          <td>
                            <a type="button" class="color-primary ml-3" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <td>
                            <a type="button" class="color-edit ml-3" data-toggle="modal" data-target="#EditModal-{{$list->id}}" >
                              <i class="fas fa-pencil-alt" aria-hidden="true"></i>
                            </a>
                          </td>
                          <td>
                            <a type="button" class="servideletebtn color-primary ml-3">
