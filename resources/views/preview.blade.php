...
<head>
    ...
    <link href="{{('preview/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{('preview/css/fontawesome-all.min.css')}}" rel="stylesheet">
    <link href="{{('preview/css/swiper.css')}}" rel="stylesheet">
	<link href="{{('preview/css/styles.css')}}" rel="stylesheet">
	
	<!-- Favicon  -->
    <link rel="icon" href="{{('preview/images/favicon.png')}}">
</head>
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-light extra-page" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html"><img src="{{('preview/images/logo.svg')}}" alt="alternative"></a> 
    ...
    <div class="ex-basic-1 pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-fluid mt-5 mb-3" src="{{('preview/images/article-details-large.jpg')}}" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <img class="img-fluid mb-5" src="{{('preview/images/article-details-small.jpg')}}" alt="alternative">
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="{{('preview/images/up-arrow.png')}}" alt="alternative">
    </button>
    <!-- end of back to top button -->
    	
    <!-- Scripts -->
    <script src="{{('preview/js/bootstrap.min.js')}}"></script> <!-- Bootstrap framework -->
    <script src="{{('preview/js/swiper.min.js')}}"></script> <!-- Swiper for image and text sliders -->
    <script src="{{('preview/js/purecounter.min.js')}}"></script> <!-- Purecounter counter for statistics numbers -->
    <script src="{{('preview/js/scripts.js')}}"></script> <!-- Custom scripts -->
</body>
</html>