...
@section('content')
    <x-layouts.header title="Prioritization Matrix"></x-layouts.header>
    {{--    <x-header title="SWOT"/>--}}
    <!-- Basic -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <img class="img-fluid mb-5" src="{{asset('preview/images/article-details-small.jpg')}}" alt="alternative">
