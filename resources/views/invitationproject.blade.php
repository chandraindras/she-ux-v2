...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">invitation Project List</h4>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        @foreach ($memberProject as $list)
                        <tr>
                          <td class="py-1">
                            <a href="{{url('/detail-project', $list->idProject)}}" class=" color-primary"> {{ $list->project_name }}</a>
                          </td>
                          <td>
                            {{ $list->email_user }}
                          </td>
                          ...
                          <td>
                            <a type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="color-primary">View Member</a>
                          ...
                          <td>
                            <a type="button" class="color-edit ml-3" data-toggle="modal" data-target="#EditModal-{{$list->idProject}}" >
                  ...
                  <div class="card" style="position: absolute; top: 285px; left: -9px; width: 315px; height: 260px;">
                    <div class="card-body">
                      ...
                      <div class="template-dem mt-4">
                        ...
                        <!-- <div class="">
                          <img src="{{ ('Dashborad/images/faces/face2.jpg') }}" alt="image"/>
                          <span>Mayshella</span>
                        </div> -->
  ...
  <!-- end-modal-create-new-project -->
   ...
   @foreach ($memberProject as $data)
    <!-- modal-EDIT-project -->
    <div class="modal fade" id="EditModal-{{$data->idProject}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content" style="  border-radius: 20px;">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form id="createProject" method="POST" action="{{ url('/project/update', $data->idProject) }}">
              @csrf
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Project Name</label>
